...
#define OLED_D0_PIN                     (P13_2)                                 // 软件 SPI SCK 引脚
#define OLED_D1_PIN                     (P13_1)                                 // 软件 SPI MOSI 引脚
//====================================================软件 SPI 驱动====================================================
#else
//====================================================硬件 SPI 驱动====================================================
#define OLED_SPI_SPEED                  (30*1000*1000	)                       // 硬件 SPI 速率
#define OLED_SPI                        (SPI_3		)                       // 硬件 SPI 号
#define OLED_D0_PIN                     (SPI3_CLK_P13_2	)                       // 硬件 SPI SCK 引脚
#define OLED_D1_PIN                     (SPI3_MOSI_P13_1)                       // 硬件 SPI MOSI 引脚
#define OLED_D1_PIN_IN                  (SPI_MISO_NULL	)                       // 定义SPI_MISO引脚  OLED没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
//====================================================硬件 SPI 驱动====================================================
#endif


#define OLED_RES_PIN                    (P14_0)                                 // 液晶复位引脚定义
#define OLED_DC_PIN                     (P14_1)                                 // 液晶命令位引脚定义
#define OLED_CS_PIN                     (P13_3)                                 // CS 片选引脚
