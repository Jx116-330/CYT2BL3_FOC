...
#define IPS114_SCL_PIN                  (P13_2)                                 // 软件 SPI SCK 引脚
#define IPS114_SDA_PIN                  (P13_1)                                 // 软件 SPI MOSI 引脚
//====================================================软件 SPI 驱动==================================================
#else
//====================================================硬件 SPI 驱动==================================================
#define IPS114_SPI_SPEED                (10*1000*1000	)                       // 硬件 SPI 速率
#define IPS114_SPI                      (SPI_3		)                       // 硬件 SPI 号
#define IPS114_SCL_PIN                  (SPI3_CLK_P13_2	)                       // 硬件 SPI SCK 引脚
#define IPS114_SDA_PIN                  (SPI3_MOSI_P13_1)                       // 硬件 SPI MOSI 引脚
#define IPS114_SDA_IN_PIN               (SPI_MISO_NULL	)                       // 定义SPI_MISO引脚  IPS没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
//====================================================硬件 SPI 驱动==================================================
#endif

#define IPS114_RST_PIN                  (P12_0)                                  // 液晶复位引脚定义
#define IPS114_DC_PIN                   (P12_1)                                  // 液晶命令位引脚定义
#define IPS114_CS_PIN                   (P13_3)                                  // CS 片选引脚
#define IPS114_BLK_PIN                  (P13_0)                                  // 液晶背光引脚定义
